...
import { UpdateQuizSessionStatus } from 'src/common/dtos/quizSession/updateQuizSessionStatus.dto';
...
export class QuizSessionController {
	...
	updateQuizSessionStatus(
		@Param('sessionId', ParseCuid2Pipe) sessionId: string,
		@Body() body: UpdateQuizSessionStatus,
		@CurrentUser() user: AccessTokenPayload,
	): Promise<GetQuizSession> {
